...
SELECT
  ...
  E.FONE,
  E.CELULAR,
  E.ENDLOGRADOURO ENDERECO,
  E.ENDNUMERO NUMERO,
  E.ENDCOMPLEMENTO COMPLEMENTO,
  E.BAIRRO,
  E.CEP,

  /* ---- MUNICÍPIO (UF + Código + Nome pelo join em MUN) ---- */
  E.MUN_UFD_SIGLA            AS UF,
  E.MUN_CODIGO               AS CIDADE_CODIGO,
  M.NOME                     AS CIDADE,

  E.CTPSNUMERO      CTPS_NUMERO,
  E.CTPSSERIE       CTPS_SERIE,
  E.CTPSDV          CTPS_DV,
  E.UFD_SIGLA_CTPS  CTPS_UF,
  E.CTPSDTEXPEDICAO CTPS_DTEXPEDICAO,
  E.IDENTIDADENUMERO ,
  ...
  (SELECT FIRST 1 F.NOME
    ...
    WHERE R.EMP_CODIGO = E.EMP_CODIGO
      AND R.EPG_CODIGO = E.CODIGO
    ORDER BY R.DATA DESC)                         AS FUNCAO,
  ...
  (SELECT FIRST 1 L.NOME
    ...
    WHERE S.EMP_CODIGO = E.EMP_CODIGO
      AND S.EPG_CODIGO = E.CODIGO
    ORDER BY S.DATA DESC)                         AS LOTACAO
